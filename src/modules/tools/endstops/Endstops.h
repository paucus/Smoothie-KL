...
class Endstops : public Module{
    ...
    private:
        ...
        float safe_homing_position[2];
        bool axis_position_known[3];
        bool autolevel_on_home;
        bool end_safe_homing_at_center_of_heatbed;
        ...
        struct {
            ...
            bool physical_boundary_endstop_gamma_enabled:1;
