...
class Extruder : public Tool {
    ...
    private:
        ...
        float get_current_hotend_temp();
        bool cold_extrusion_prevention_feature_enabled;
        float cold_extrusion_temperature;
        bool cold_extrusion_prevention_event_enabled;
        bool cold_extrusion;
        time_t cold_extrusion_last_report;
