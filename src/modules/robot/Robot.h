...
class Robot : public Module {
    public:
        ...
        void on_print_status_change(void * args);
        ...
        float get_seek_rate() const { return seek_rate; }
        ...
        struct slope_pt { float x; float y; slope_pt(float x, float y){this->x=x;this->y=y;};};
        std::function<void(struct slope_pt, float*)> slopeTransform;
        // END MODIF autolevel
        // BEGIN MODIF client_print
    ...
    private:
        ...
        // BEGIN MODIF autolevel
        friend class MultiPointStrategy;
        // END MODIF autolevel
    ...
    public:
        ...
        // BEGIN MODIF boundaries
        float max_coord_value[3];
        float min_coord_value[3];
        // END MODIF boundaries
};
