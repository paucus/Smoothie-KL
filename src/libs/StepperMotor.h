...
#define MAX_POSITION_STEPS 0x7fffffff
...
class StepperMotor {
    public:
        ...
        int32_t get_max_position_steps() { return max_position_steps; };
        void set_max_position_steps(int32_t s) { max_position_steps = s; };
