...
const ModuleCallback kernel_callback_functions[NUMBER_OF_DEFINED_EVENTS] = {
    ...
    &Module::on_halt,
    &Module::on_out_of_filament,
    &Module::on_cold_extrusion,
    &Module::on_alert_triggered,
    &Module::on_print_status_change,
    &Module::on_autolevel_status_change,
    &Module::on_upgrade_process_begin,
    &Module::on_pid_autotune_event,
    &Module::on_connection_change,
    // END MODIF filament
};
