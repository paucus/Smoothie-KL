...
enum _EVENT_ENUM {
    ...
    ON_COLD_EXTRUSION,
    ON_ALERT_TRIGGERED,
    ON_PRINT_STATUS_CHANGE,
    ON_AUTOLEVEL_STATUS_CHANGE,
    ON_UPGRADE_PROCESS_BEGIN,
    ON_PID_AUTOTUNE_EVENT,
...
public:
    ...
    // BEGIN MODIF filament
    virtual void on_out_of_filament(void *) {};
    virtual void on_cold_extrusion(void *) {};
    virtual void on_alert_triggered(void *) {};
    virtual void on_print_status_change(void *) {};
    virtual void on_autolevel_status_change(void *) {};
    virtual void on_upgrade_process_begin(void *) {};
    virtual void on_pid_autotune_event(void *) {};
    virtual void on_connection_change(void *) {};
    // END MODIF filament
